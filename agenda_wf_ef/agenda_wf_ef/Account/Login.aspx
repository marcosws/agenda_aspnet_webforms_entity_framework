<%@ Page Title="Log In" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeBehind="Login.aspx.cs" Inherits="agenda_wf_ef.Account.Login" %>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    ...
    <p>
        Entre com seu E-mail e Senha cadastrado para entrar.
        <asp:HyperLink ID="RegisterHyperLink" runat="server" EnableViewState="false"> Registar </asp:HyperLink> caso não possuir uma Conta.
    </p>
